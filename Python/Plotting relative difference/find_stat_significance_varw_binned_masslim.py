...
import findVol
import binned_comoving_volume

# Vectorize the functions from findVol
...
# Vectorize / use namespace for the functions from binned_comoving_volume
delta_galaxy_number_rel_z_comb_masslim = binned_comoving_volume.delta_galaxy_number_rel_z_comb_masslim
