...
for sqd in sqds:
    ...
    ax1.set_title("min. app. magnitude = " + str(magnitude_min))
    ax1.plot(z, rel_num_LCDM_h1, '-.', label=r'$h=$' + str(h1*100) + r'$km s^{-1} Mpc^{-1}$')
    ax1.plot(z, rel_num_LCDM_h2, '-', label=r'$h=$' + str(h2*100) + r'$km s^{-1} Mpc^{-1}$')
    ax1.plot(z, rel_num_LCDM_h3, ':', label=r'$h=$' + str(h3*100) + r'$km s^{-1} Mpc^{-1}$')
    ...
    fig1.savefig(report_save_path + '_hcomp' + '_minM' + str(magnitude_min) + '_sqd' + str(sqd) + '_const' + '_zref' + str(z_ref) + '_wErr' + '.pdf', format='pdf')
...
plt.rc('ytick', labelsize=11)
plt.tight_layout()
fig2.savefig(save_path + '_sd' + '_hcomp' + '_var' + '_zref' + str(z_ref) + '_minM' + str(magnitude_min) + '_wErr' + '.png')
fig2.savefig(report_save_path + '_sd' + '_hcomp' + '_const' + '_zref' + str(z_ref) + '_minM' + str(magnitude_min) + '_wErr' + '.pdf', format='pdf')