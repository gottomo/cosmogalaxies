...
def delta_galaxy_number_rel_z_comb_masslim(z, z_ref, ratio, mass, break_mass, phi1, phi2, alpha1, alpha2, omega_m, omega_k, omega_0, model, w_0=-1, w_1=0, h=0.7, sqd=1):
    # Returns the difference in number density of galaxies between an arbitrary z and a set z
    z_bin = np.array([])
    volume = np.array([])
    i=0
...
def delta_galaxy_density_rel_z_comb_masslim(z, z_ref, ratio, mass, break_mass, phi1, phi2, alpha1, alpha2, omega_m, omega_k, omega_0, model, w_0=-1, w_1=0, h=0.7, sqd=1):
    # Returns the difference in number density of galaxies between an arbitrary z and a set z
    z_bin = np.array([])
    volume = np.array([])
    i=0
...
# Uses single schechter function with no galaxy formaitons
# fig1, ax1 = plt.subplots()
# z_ref = 3
# ratio = 5
# ax1.set_ylabel(r"Relative galaxy numbers $N$")
# ax1.set_xlabel(r"$z$")
# rel_num_LCDM, d_rel_num_LCDM = delta_galaxy_number_rel_z_comb_masslim(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(z_ref, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(z_ref, -0.093, -1.3), -1.47, 0.3, 0, 0.7, 'LCDM', h=h_today, sqd = sqd)
# rel_num_w8, d_rel_num_w8 = delta_galaxy_number_rel_z_comb_masslim(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(z_ref, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(z_ref, -0.093, -1.3), -1.47, 0.3, 0, 0.7,  'constant_w', -0.8, h=h_today, sqd = sqd)
# rel_num_w9, d_rel_num_w9 = delta_galaxy_number_rel_z_comb_masslim(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(z_ref, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(z_ref, -0.093, -1.3), -1.47, 0.3, 0, 0.7,  'constant_w', -0.9, h=h_today, sqd = sqd)
# rel_num_w11, d_rel_num_w11 = delta_galaxy_number_rel_z_comb_masslim(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(z_ref, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(z_ref, -0.093, -1.3), -1.47, 0.3, 0, 0.7, 'constant_w', -1.1, h=h_today, sqd = sqd)
# rel_num_w12, d_rel_num_w12 = delta_galaxy_number_rel_z_comb_masslim(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(z_ref, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(z_ref, -0.093, -1.3), -1.47, 0.3, 0, 0.7, 'constant_w', -1.2, h=h_today, sqd = sqd)
...
# ax1.legend()
# plt.tight_layout()
# fig1.savefig(save_path  + 'reldif' + '_binsize' + str(bin_size) + '_const' + '_ratio' + str(ratio) + '_minMass' + str(mass_min) + '_sqd' + str(sqd) + '_var' + '_zref' + str(z_ref) + '_wErr' + '.png')
# plt.show()
...
# ax1.set_ylabel(r"Relative galaxy number density (1 / redshift Mpc$^2$)")
# ax1.set_xlabel(r"$z$")
# rel_num_LCDM, d_rel_num_LCDM = delta_galaxy_density_rel_z_comb_masslim(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(3, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(3, -0.093, -1.3), -1.47, 0.3, 0, 0.7, 'LCDM', h=h_today, sqd = sqd)
# rel_num_w8, d_rel_num_w8 = delta_galaxy_density_rel_z_comb_masslim(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(3, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(3, -0.093, -1.3), -1.47, 0.3, 0, 0.7,  'constant_w', -0.8, h=h_today, sqd = sqd)
# rel_num_w9, d_rel_num_w9 = delta_galaxy_density_rel_z_comb_masslim(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(3, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(3, -0.093, -1.3), -1.47, 0.3, 0, 0.7,  'constant_w', -0.9, h=h_today, sqd = sqd)
# rel_num_w11, d_rel_num_w11 = delta_galaxy_density_rel_z_comb_masslim(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(3, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(3, -0.093, -1.3), -1.47, 0.3, 0, 0.7, 'constant_w', -1.1, h=h_today, sqd = sqd)
# rel_num_w12, d_rel_num_w12 = delta_galaxy_density_rel_z_comb_masslim(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(3, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(3, -0.093, -1.3), -1.47, 0.3, 0, 0.7, 'constant_w', -1.2, h=h_today, sqd = sqd)
# rel_num_EdS, d_rel_num_EdS = delta_galaxy_density_rel_z_comb_masslim(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(3, 11, 2.88e-3, 1, 0, 0, "LCDM", h=h_today), 0, alpha(3, -0.093, -1.3), -1.47, 1, 0, 0, 'LCDM', h=h_today, sqd = sqd)
# rel_num_OCDM, d_rel_num_OCDM = delta_galaxy_density_rel_z_comb_masslim(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(3, 11, 2.88e-3, 0.3, 0.7, 0, "LCDM", h=h_today), 0, alpha(3, -0.093, -1.3), -1.47, 0.3, 0.7, 0, 'LCDM', h=h_today, sqd = sqd)
...
# z_ref = 3
# ratio = 5
# num_LCDM = galaxy_no_density_masslim_vec(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(3, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(3, -0.093, -1.3), -1.47, 0.3, 0, 0.7, 'LCDM', h=h_today)
# num_w8 = galaxy_no_density_masslim_vec(z_array, z_ref, ratio,  mass_min, 11.12, Phi_directVec(3, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(3, -0.093, -1.3), -1.47, 0.3, 0, 0.7,  'constant_w', -0.8, h=h_today)
# num_w9 = galaxy_no_density_masslim_vec(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(3, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(3, -0.093, -1.3), -1.47, 0.3, 0, 0.7,  'constant_w', -0.9, h=h_today)
# num_w11 = galaxy_no_density_masslim_vec(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(3, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(3, -0.093, -1.3), -1.47, 0.3, 0, 0.7, 'constant_w', -1.1, h=h_today)
# num_w12 = galaxy_no_density_masslim_vec(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(3, 11, 2.88e-3, 0.3, 0, 0.7, "LCDM", h=h_today), 0, alpha(3, -0.093, -1.3), -1.47, 0.3, 0, 0.7, 'constant_w', -1.2, h=h_today)
# num_EdS = galaxy_no_density_masslim_vec(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(3, 11, 2.88e-3, 1, 0, 0, "LCDM", h=h_today), 0, alpha(3, -0.093, -1.3), -1.47, 1, 0, 0, 'LCDM', h=h_today)
# num_OCDM = galaxy_no_density_masslim_vec(z_array, z_ref, ratio, mass_min, 11.12, Phi_directVec(3, 11, 2.88e-3, 0.3, 0.7, 0, "LCDM", h=h_today), 0, alpha(3, -0.093, -1.3), -1.47, 0.3, 0.7, 0, 'LCDM', h=h_today)
...
# ax1_2.legend()
# plt.tight_layout()
# fig1_2.savefig(save_path + 'schechter_density' + '_const' + '_ratio' + str(ratio) + '_binsize' + str(bin_size) + 'minMass' + str(mass_min) + '.png')
# # fig1_1.savefig(save_path + 'comoving_vol' + '_binsize' + str(bin_size) + '_zref' + str(z_ref) + '.pdf')
# plt.show()
# plt.clf()
