...
zArray = np.linspace(0.001, zRef, num = 30)
np.savetxt("zs.txt", zArray)

hs = np.linspace(0.67, 0.73, num = 70)
np.savetxt("Hs.txt", hs)

ws = np.linspace(-1.3, -0.7, num = 70)
np.savetxt("Ws.txt", hs)



#[np.savetxt("FitToH%i.txt"%(hnum[0]), np.vstack(((zArray, delta_galaxy_number_rel_z_vec(zArray, zRef, mag, 10.66, 3.96e-3, 0.79e-3, -0.35, -1.47, 0.3, 0, 0.7, 'LCDM', h = hnum[1])))).T) for hnum in enumerate(hs)]

#[np.savetxt("FitToW%i.txt"%(wnum[0]), np.vstack(((zArray, delta_galaxy_number_rel_z_vec(zArray, zRef, mag, 10.66, 3.96e-3, 0.79e-3, -0.35, -1.47, 0.3, 0, 0.7, "constant_w", w_0 = wnum[1])))).T) for wnum in enumerate(ws)]


# =============================================================================
# test1 = np.vstack(((zArray, delta_galaxy_number_rel_z_vec(zArray, zRef, 25, 10.66, 3.96e-3, 0.79e-3, -0.35, -1.47, 0.3, 0, 0.7, 'LCDM', h = 0.67)))).T
# test2 = np.vstack(((zArray, delta_galaxy_number_rel_z_vec(zArray, zRef, 25, 10.66, 3.96e-3, 0.79e-3, -0.35, -1.47, 0.3, 0, 0.7, 'LCDM', h = 0.70)))).T
# test3 = np.vstack(((zArray, delta_galaxy_number_rel_z_vec(zArray, zRef, 25, 10.66, 3.96e-3, 0.79e-3, -0.35, -1.47, 0.3, 0, 0.7, 'LCDM', h = 0.73)))).T
# 
...
# =============================================================================
# 
# test1 = np.vstack(((zArray, delta_galaxy_number_rel_z_vec(zArray, zRef, 27, 10.66, 3.96e-3, 0.79e-3, -0.35, -1.47, 0.3, 0, 0.7, 'LCDM', h = 0.67)))).T
# test2 = np.vstack(((zArray, delta_galaxy_number_rel_z_vec(zArray, zRef, 27, 10.66, 3.96e-3, 0.79e-3, -0.35, -1.47, 0.3, 0, 0.7, 'LCDM', h = 0.70)))).T
# test3 = np.vstack(((zArray, delta_galaxy_number_rel_z_vec(zArray, zRef, 27, 10.66, 3.96e-3, 0.79e-3, -0.35, -1.47, 0.3, 0, 0.7, 'LCDM', h = 0.73)))).T
# 
# plt.plot(test1[:,0], test1[:,1])
# plt.plot(test2[:,0], test2[:,1])
# plt.plot(test3[:,0], test3[:,1])
...
# =============================================================================
# test1 = np.vstack(((zArray, delta_galaxy_number_rel_z_vec(zArray, zRef, 25, 10.66, 3.96e-3, 0.79e-3, -0.35, -1.47, 0.3, 0, 0.7, "constant_w", w_0 =-0.7)))).T
# test2 = np.vstack(((zArray, delta_galaxy_number_rel_z_vec(zArray, zRef, 25, 10.66, 3.96e-3, 0.79e-3, -0.35, -1.47, 0.3, 0, 0.7, "constant_w", w_0 =-1)))).T
# test3 = np.vstack(((zArray, delta_galaxy_number_rel_z_vec(zArray, zRef, 25, 10.66, 3.96e-3, 0.79e-3, -0.35, -1.47, 0.3, 0, 0.7, "constant_w", w_0 =-1.3)))).T
# 
# plt.plot(test1[:,0], test1[:,1])
# plt.plot(test2[:,0], test2[:,1])
# plt.plot(test3[:,0], test3[:,1])
...
# =============================================================================
# test1 = np.vstack(((zArray, delta_galaxy_number_rel_z_vec(zArray, zRef, 27, 10.66, 3.96e-3, 0.79e-3, -0.35, -1.47, 0.3, 0, 0.7, "constant_w", w_0 =-0.7)))).T
# test2 = np.vstack(((zArray, delta_galaxy_number_rel_z_vec(zArray, zRef, 27, 10.66, 3.96e-3, 0.79e-3, -0.35, -1.47, 0.3, 0, 0.7, "constant_w", w_0 =-1)))).T
# test3 = np.vstack(((zArray, delta_galaxy_number_rel_z_vec(zArray, zRef, 27, 10.66, 3.96e-3, 0.79e-3, -0.35, -1.47, 0.3, 0, 0.7, "constant_w", w_0 =-1.3)))).T
# 
# plt.plot(test1[:,0], test1[:,1])
# plt.plot(test2[:,0], test2[:,1])
# plt.plot(test3[:,0], test3[:,1])
...
VarHData = np.loadtxt("ParamsVarH.txt")
VarWData = np.loadtxt("ParamsVarW.txt")


plt.fill_between(hs, VarHData[:,0] + VarHData[:,1], VarHData[:,0] - VarHData[:,1],  alpha=0.5)
plt.plot(hs, VarHData[:,0], color = "crimson")

plt.ylabel("Fit parameter a")#, fontsize = 20)
plt.xlabel("Hubble constant h")#, fontsize = 20)
plt.title("Hubble constant vs Fit parameter a \n LCDM fit on relative number of galaxies (0.5<z<2.5), at mag%i"%(mag))

plt.show()

plt.fill_between(hs, VarHData[:,2] + VarHData[:,3], VarHData[:,2] - VarHData[:,3],  alpha=0.5)
plt.plot(hs, VarHData[:,2], color = "crimson")
plt.ylabel("Fit parameter m")#, fontsize = 20)
plt.xlabel("Hubble constant h")#, fontsize = 20)
plt.title("Hubble constant vs Fit parameter m \n LCDM fit on relative number of galaxies (0.5<z<2.5), at mag%i"%(mag))

plt.show()

plt.fill_between(hs, VarHData[:,4] + VarHData[:,5], VarHData[:,4] - VarHData[:,5],  alpha=0.5)
plt.plot(hs, VarHData[:,4], color = "crimson")
plt.ylabel("Fit parameter b")#, fontsize = 20)
plt.xlabel("Hubble constant h")#, fontsize = 20)
plt.title("Hubble constant vs Fit parameter b \n LCDM fit on relative number of galaxies (0.5<z<2.5), at mag%i"%(mag))

plt.show()

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

plt.fill_between(ws, VarWData[:,0] + VarWData[:,1], VarWData[:,0] - VarWData[:,1],  alpha=0.5)
plt.plot(ws, VarWData[:,0], color = "crimson")

plt.ylabel("Fit parameter a")#, fontsize = 20)
plt.xlabel("Cosmological constant w")#, fontsize = 20)
plt.title("Csomological constant vs Fit parameter a \n LCDM fit on relative number of galaxies (0.5<z<2.5), at mag%i"%(mag))

plt.show()

plt.fill_between(ws, VarWData[:,2] + VarWData[:,3], VarWData[:,2] - VarWData[:,3],  alpha=0.5)
plt.plot(ws, VarWData[:,2], color = "crimson")
plt.ylabel("Fit parameter m")#, fontsize = 20)
plt.xlabel("Cosmological constant w")#, fontsize = 20)
plt.title("Csomological constant vs Fit parameter m \n LCDM fit on relative number of galaxies (0.5<z<2.5), at mag%i"%(mag))

plt.show()

plt.fill_between(ws, VarWData[:,4] + VarWData[:,5], VarWData[:,4] - VarWData[:,5],  alpha=0.5)
plt.plot(ws, VarWData[:,4], color = "crimson")
plt.ylabel("Fit parameter b")#, fontsize = 20)
plt.xlabel("Cosmological constant w")#, fontsize = 20)
plt.title("Csomological constant vs Fit parameter b \n LCDM fit on relative number of galaxies (0.5<z<2.5), at mag%i"%(mag))
